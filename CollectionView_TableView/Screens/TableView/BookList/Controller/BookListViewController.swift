...
class BookListViewController: UIViewController {
    ...
    // MARK: - Properties
    var queueDownload: DispatchQueue = DispatchQueue(label: "com.CollectionView_TableView.downloadDataQueue", attributes: .concurrent)
            ...
            DispatchQueue.global().async {
                do {
                    ...
                    if let items = responseObj.items {
                        self.queueDownload.async(flags: .barrier, execute: {
